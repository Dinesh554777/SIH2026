...
function PrintableAdvisory({ forecast, decision, village, onClose }) {
  const handlePrint = () => {
    window.print();
  };
    ...
    <div style={{
      ...
      <div className="glass-panel printable-area" style={{ 
        ...
        <div style={{ marginBottom: '40px' }}>
          <h3 style={{ fontSize: '16px', borderBottom: '1px solid #ccc', paddingBottom: '5px' }}>Advisory Message / செய்தி</h3>
          <p style={{ fontSize: '16px', lineHeight: '1.6' }}>
            English: Monsoon onset conditions are currently evaluated as {forecast?.prediction?.status || 'Likely'}. 
          ...
          <p style={{ fontSize: '16px', lineHeight: '1.6', marginTop: '15px' }}>
            தமிழ்: பருவமழை நிலை தற்போது {forecast?.prediction?.status || 'சாத்தியம்'} என மதிப்பிடப்பட்டுள்ளது. 
